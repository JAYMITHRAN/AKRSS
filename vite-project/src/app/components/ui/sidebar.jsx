...
// ... (keep topmost imports and logic)

// Replace cva with standard class names or kept logic but mapped to CSS classes
    ...
    >
      ...
      >
        <div
          ...
          className="sidebar group-data-[variant=floating]:border-sidebar-border h-full w-full group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
// ... (other components updated similarly)
...
function SidebarContent({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "sidebar-content group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
...
function SidebarGroupContent({
  ...
  return (
    <div
      ...
      className={cn("w-full text-sm", className)} // text-sm is std
      {...props}
    />
  );
}
...
function SidebarMenuItem({ className, ...props }) {
  return (
    <li
      ...
      className={cn("sidebar-menu-item group/menu-item", className)}
      {...props}
    />
  );
}
